...
-------------------------------------------------------------------------------
-- AddExtraHills - Adds extra hills to the map to increase terrain variation
-- Can be called from any map script that includes BBM_MapUtils
-- @param plotTypes - The plotTypes array to modify
-- @return plotTypes - The modified plotTypes array with added hills
-------------------------------------------------------------------------------
function AddExtraHills(plotTypes)
    ...
    local hillsAdded = 0;
    local hillConversionChance = 16; -- 16% base chance to convert flat land to hills
