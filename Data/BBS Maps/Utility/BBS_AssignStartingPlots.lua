...
function BBS_AssignStartingPlots.Create(args)
    ...
    print("Init: Ridge: ", MapConfiguration.GetValue("BBSRidge"),
        "0 = Standard, 1 = Classic, 2 = Large Open 4 = Flat Earth");
    print("Init: Sea Level: ", MapConfiguration.GetValue("sea_level"),
        "1 = Low Sea Level, 2 = Standard, 3 = High Sea Level");
    ...
    if (MapConfiguration.GetValue("MAP_SCRIPT") == "Pangaea.lua" or MapConfiguration.GetValue("MAP_SCRIPT") ==
        "Continents.lua" or MapConfiguration.GetValue("MAP_SCRIPT") == "Terra.lua") then
    ...
    if minDistance ~= nil and minDistance ~= 0 then
        ...
        if mapScript == "Pangaea.lua" or mapScript == "DWPangaea.lua" or mapScript == "Shuffle.lua" or mapScript ==
            "Tilted_Axis.lua" then
            Major_Distance_Target = 12
        end

        if mapScript == "Fractal.lua" or mapScript == "Island_Plates.lua" or mapScript == "Small_Continents.lua" or
            mapScript == "Archipelago_XP2.lua" or mapScript == "Continents.lua" or mapScript == "Wetlands_XP2.lua" or
            mapScript == "Continents_Islands.lua" or mapScript == "Splintered_Fractal.lua" or mapScript ==
            "DWArchipelago.lua" or mapScript == "DWFractal.lua" or mapScript == "DWMixedLand.lua" or mapScript ==
            "DWSmallContinents.lua" or mapScript == "DWMixedIslands.lua" then
            Major_Distance_Target = 10
        end
...
function terraformBBS(x, y, newTerrain, newResource, newFeature)
    ...
    if (newTerrain ~= -2) then -- -2 = no change
        ...
        if (mapFeatureCode[xIndex][yIndex] == 0 or mapFeatureCode[xIndex][yIndex] == 31 or
            mapFeatureCode[xIndex][yIndex] == 32) then -- floodplains, need an update
            ...
            elseif newTerrain == 3 then -- plain
                ...
                ___Debug("Warning, terraformed a flooded tiles, without proper terrain:, X:", x, "Y:", y,
...
function negativeBiasFeatureScore(negativeBias, percentageR3, percentageR5)
    ...
    if negativeBias == 1 then
        ...
        elseif percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B1_R3 - 0.03 and percentageR5 <=
            NEGATIVE_FEATURE_PERCENTAGE_B1_R5 - 0.03 then
            score = score + 100;
    ...
    elseif negativeBias == 2 then
        ...
        if percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B2_R3 and percentageR5 <= NEGATIVE_FEATURE_PERCENTAGE_B2_R5 then
            score = score + 500;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B2_R3 - 0.03 and percentageR5 <=
            NEGATIVE_FEATURE_PERCENTAGE_B2_R5 - 0.03 then
            score = score + 100;
            -- negativeBias not respected
        else
            score = score - 1000;
    ...
    elseif negativeBias == 3 then
        ...
        if percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B3_R3 and percentageR5 <= NEGATIVE_FEATURE_PERCENTAGE_B3_R5 then
            score = score + 1000;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B3_R3 - 0.03 and percentageR5 <=
            NEGATIVE_FEATURE_PERCENTAGE_B3_R5 - 0.03 then
            score = score + 100;
            -- negativeBias not respected
        else
            score = score - 2000;
    ...
    elseif negativeBias == 4 then
        ...
        if percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B4_R3 and percentageR5 <= NEGATIVE_FEATURE_PERCENTAGE_B4_R5 then
            score = score + 500;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_FEATURE_PERCENTAGE_B4_R3 - 0.02 and percentageR5 <=
            NEGATIVE_FEATURE_PERCENTAGE_B4_R5 - 0.02 then
            score = score + 50;
            -- negativeBias not respected
        else
            score = score - 1000;
...
function biasDesertScore(bias, percentageR3, percentageR5)
    ...
    elseif bias == -1 then
        ...
        if percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B1_R3 and percentageR5 <= NEGATIVE_DESERT_PERCENTAGE_B1_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B1_R3 + 0.05 and percentageR5 <=
            NEGATIVE_DESERT_PERCENTAGE_B1_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -2 then
        ...
        if percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B2_R3 and percentageR5 <= NEGATIVE_DESERT_PERCENTAGE_B2_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B2_R3 + 0.05 and percentageR5 <=
            NEGATIVE_DESERT_PERCENTAGE_B2_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -3 then
        ...
        if percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B3_R3 and percentageR5 <= NEGATIVE_DESERT_PERCENTAGE_B3_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B3_R3 + 0.05 and percentageR5 <=
            NEGATIVE_DESERT_PERCENTAGE_B3_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -4 then
        ...
        if percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B4_R3 and percentageR5 <= NEGATIVE_DESERT_PERCENTAGE_B4_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B4_R3 + 0.05 and percentageR5 <=
            NEGATIVE_DESERT_PERCENTAGE_B4_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -5 then
        ...
        if percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B5_R3 and percentageR5 <= NEGATIVE_DESERT_PERCENTAGE_B5_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_DESERT_PERCENTAGE_B5_R3 + 0.05 and percentageR5 <=
            NEGATIVE_DESERT_PERCENTAGE_B5_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 400;
...
function negativeBiasResourceScore(negativeBias, percentageR3, percentageR5)
    ...
    if negativeBias == 1 then
        ...
        if percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B1_R3 and percentageR5 <= NEGATIVE_RESOURCE_PERCENTAGE_B1_R5 then
            score = score + 1000;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B1_R3 - 0.03 and percentageR5 <=
            NEGATIVE_RESOURCE_PERCENTAGE_B1_R5 - 0.03 then
            score = score + 100;
            -- negativeBias not respected
        else
            score = score - 2000;
    ...
    elseif negativeBias == 2 then
        ...
        if percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B2_R3 and percentageR5 <= NEGATIVE_RESOURCE_PERCENTAGE_B2_R5 then
            score = score + 500;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B2_R3 - 0.03 and percentageR5 <=
            NEGATIVE_RESOURCE_PERCENTAGE_B2_R5 - 0.03 then
            score = score + 100;
            -- negativeBias not respected
        else
            score = score - 1000;
    ...
    elseif negativeBias == 3 then
        ...
        if percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B3_R3 and percentageR5 <= NEGATIVE_RESOURCE_PERCENTAGE_B3_R5 then
            score = score + 1000;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B3_R3 - 0.03 and percentageR5 <=
            NEGATIVE_RESOURCE_PERCENTAGE_B3_R5 - 0.03 then
            score = score + 100;
            -- negativeBias not respected
        else
            score = score - 2000;
    ...
    elseif negativeBias == 4 then
        ...
        if percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B4_R3 and percentageR5 <= NEGATIVE_RESOURCE_PERCENTAGE_B4_R5 then
            score = score + 500;
            -- negativeBias somewhat respected
        elseif percentageR3 <= NEGATIVE_RESOURCE_PERCENTAGE_B4_R3 - 0.02 and percentageR5 <=
            NEGATIVE_RESOURCE_PERCENTAGE_B4_R5 - 0.02 then
            score = score + 50;
            -- negativeBias not respected
        else
            score = score - 1000;
...
function biasTerrainScore(bias, percentageR3, percentageR5)
    ...
    elseif bias == -1 then
        ...
        if percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B1_R3 and percentageR5 <= NEGATIVE_TERRAIN_PERCENTAGE_B1_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B1_R3 + 0.05 and percentageR5 <=
            NEGATIVE_TERRAIN_PERCENTAGE_B1_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -2 then
        ...
        if percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B2_R3 and percentageR5 <= NEGATIVE_TERRAIN_PERCENTAGE_B2_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B2_R3 + 0.05 and percentageR5 <=
            NEGATIVE_TERRAIN_PERCENTAGE_B2_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -3 then
        ...
        if percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B3_R3 and percentageR5 <= NEGATIVE_TERRAIN_PERCENTAGE_B3_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B3_R3 + 0.05 and percentageR5 <=
            NEGATIVE_TERRAIN_PERCENTAGE_B3_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -4 then
        ...
        if percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B4_R3 and percentageR5 <= NEGATIVE_TERRAIN_PERCENTAGE_B4_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B4_R3 + 0.05 and percentageR5 <=
            NEGATIVE_TERRAIN_PERCENTAGE_B4_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -5 then
        ...
        if percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B5_R3 and percentageR5 <= NEGATIVE_TERRAIN_PERCENTAGE_B5_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_TERRAIN_PERCENTAGE_B5_R3 + 0.05 and percentageR5 <=
            NEGATIVE_TERRAIN_PERCENTAGE_B5_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 400;
...
function biasMountainScore(bias, percentageR3, percentageR5)
    ...
    elseif bias == -1 then
        ...
        if percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B1_R3 and percentageR5 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B1_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B1_R3 + 0.05 and percentageR5 <=
            NEGATIVE_MOUNTAIN_PERCENTAGE_B1_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -2 then
        ...
        if percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B2_R3 and percentageR5 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B2_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B2_R3 + 0.05 and percentageR5 <=
            NEGATIVE_MOUNTAIN_PERCENTAGE_B2_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -3 then
        ...
        if percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B3_R3 and percentageR5 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B3_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B3_R3 + 0.05 and percentageR5 <=
            NEGATIVE_MOUNTAIN_PERCENTAGE_B3_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 2000;
    ...
    elseif bias == -4 then
        ...
        if percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B4_R3 and percentageR5 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B4_R5 then
            score = score + 1000;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B4_R3 + 0.05 and percentageR5 <=
            NEGATIVE_MOUNTAIN_PERCENTAGE_B4_R5 - 0.05 then
            score = score + 100;
            -- bias not respected
        else
            score = score - 1000;
    ...
    elseif bias == -5 then
        ...
        if percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B5_R3 and percentageR5 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B5_R5 then
            score = score + 500;
            -- bias somewhat respected
        elseif percentageR3 <= NEGATIVE_MOUNTAIN_PERCENTAGE_B5_R3 + 0.05 and percentageR5 <=
            NEGATIVE_MOUNTAIN_PERCENTAGE_B5_R5 - 0.05 then
            score = score + 50;
            -- bias not respected
        else
            score = score - 400;
...
function NewBBS(instance)
    ...
    if (mapScript == "Island_Plates.lua" or mapScript == "Small_Continents.lua" or mapScript == "Archipelago_XP2.lua" or
        mapScript == "DWArchipelago.lua" or mapScript == "DWSmallContinents.lua" or mapScript == "DWMixedIslands.lua") then
        isIslandMap = true;
    else
        isIslandMap = false;
    end
   ...
   --]]
    ...
    mountainCount = terrainCount[2 + 1] + terrainCount[5 + 1] + terrainCount[8 + 1] + terrainCount[11 + 1] +
                        terrainCount[14 + 1];
    hillsCount = terrainCount[1 + 1] + terrainCount[4 + 1] + terrainCount[7 + 1] + terrainCount[10 + 1] +
                     terrainCount[13 + 1];
   ...
   --]]
        ...
        for j = 0, mapYSize - 1 do
            ...
            if (mapTerrainCode[iIndex][jIndex] < 15) then
                ...
                for _, element in ipairs(list) do
                    ...
                    elseif (mapFeatureCode[x + 1][y + 1] == 0 or mapFeatureCode[x + 1][y + 1] == 31 or
                        mapFeatureCode[x + 1][y + 1] == 32) then
         ...
         --]]
            ...
            if ((mapResourceCode[iIndex][jIndex] == 17 or mapResourceCode[iIndex][jIndex] == 4 or
                mapResourceCode[iIndex][jIndex] == 19) and
         ...
         --]]
            ...
            if ((mapResourceCode[iIndex][jIndex] == 53 or mapResourceCode[iIndex][jIndex] == 10 or
                mapResourceCode[iIndex][jIndex] == 28) and (mapFreshWater[iIndex][jIndex] or mapCoastal[iIndex][jIndex]) and
    ...
    for i = 1, PlayerManager.GetAliveMajorsCount() do
        ...
        if (PlayerConfigurations[tempMajorList[i]]:GetLeaderTypeName() == "LEADER_SPECTATOR" or
            PlayerConfigurations[tempMajorList[i]]:GetHandicapTypeID() == 2021024770) then
                ...
                for _, element in ipairs(tempBias) do
                    ...
                    if (element.Type == "TERRAINS") then
                        if (element.Value ~= nil and element.Tier ~= nil) then
                            ...
                            print("Warning: wrongly read bias: Type, ID, Tier", element.Type, element.Value,
                                element.Tier, civName);
                        end
            ...
            for k = 1, 200 do
                ...
                if resourceNegativeBiasValue < 0 then
                    ...
                    resourcesNegativeBiasListCount[resourceNegativeBiasValue] =
                        resourcesNegativeBiasListCount[resourceNegativeBiasValue] + 1;
                    resourcesNegativeBiasList[resourceNegativeBiasValue][resourcesNegativeBiasListCount[resourceNegativeBiasValue]] =
                        resource;
                end
                ...
                if featureNegativeBiasValue < 0 then
                    ...
                    featuresNegativeBiasListCount[featureNegativeBiasValue] =
                        featuresNegativeBiasListCount[featureNegativeBiasValue] + 1;
                    featuresNegativeBiasList[featureNegativeBiasValue][featuresNegativeBiasListCount[featureNegativeBiasValue]] =
                        feature;
                end
            ...
            majorAll[majorCount] = {
                index = i,
                civName = civName,
                civID = tempMajorList[i],
                major = PlayerConfigurations[tempMajorList[i]],
                biases = majorBiases[i],
                biasScore = biasScore,
                biasCount = biasCount,
                tundraCiv = tundraCiv,
                floodPlainsCiv = floodPlainsCiv,
                biasTerrain = biasTerrain,
                biasFeature = biasFeature,
                biasResource = biasResource,
                bestBias = bestBias,
                resourcesBiasList = resourcesBiasList,
                resourcesBiasListCount = resourcesBiasListCount,
                featuresBiasList = featuresBiasList,
                featuresBiasListCount = featuresBiasListCount,
                resourcesNegativeBiasList = resourcesNegativeBiasList,
                resourcesNegativeBiasListCount = resourcesNegativeBiasListCount,
                featuresNegativeBiasList = featuresNegativeBiasList,
                featuresNegativeBiasListCount = featuresNegativeBiasListCount,
                isNorthKing = isNorthKing,
                continentSplit = continentSplit,
                isHydrophobic = isHydrophobic,
                isSalty = isSalty,
                isMountainLover = isMountainLover,
                riverBias = riverCiv,
                majorPrimaryOKSecondaryOKWaterOK = {},
                majorPrimaryOKSecondaryOKSeaOK = {},
                majorPrimaryOKSecondaryOKWaterNOK = {},
                majorPrimaryOKSecondaryNOKWaterOK = {},
                majorPrimaryOKSecondaryNOKSeaOK = {},
                majorPrimaryOKSecondaryNOKWaterNOK = {},
                majorPrimaryOKSecondaryOKWaterOKCount = 0,
                majorPrimaryOKSecondaryOKSeaOKCount = 0,
                majorPrimaryOKSecondaryOKWaterNOKCount = 0,
                majorPrimaryOKSecondaryNOKWaterOKCount = 0,
                majorPrimaryOKSecondaryNOKSeaOKCount = 0,
                majorPrimaryOKSecondaryNOKWaterNOKCount = 0,
                spawnX = -1,
                spawnY = -1,
                freshWaterSpawn = false,
                teamID = teamID,
                rtsFreeSim = false
            };
    ...
    if instance.iTeamPlacement == 1 and
        (mapScript == "Pangaea.lua" or mapScript == "Continents_Islands.lua" or mapScript == "Continents.lua") and
        teamCount == 2 then
...
function assignSpawns(majorAll, majorCount, minorAll, minorCount, playerDistance)
    ...
    for i = 1, attempts do
        ...
        if (recursivePlacement(majorShuffled, majorCount, 1, proximityMap, distance, mapXSize, mapYSize,
            mapIsRoundWestEast, -1, standardWaterIndex, standardCoastIndex, standardNoWaterIndex)) then
    ...
    if (settleSuccess) then
        ...
        if (mapResourceCode[player.spawnX + 1][player.spawnY + 1] ~= -1) then
            ___Debug("Player spawned on a resource:", mapResourceCode[player.spawnX + 1][player.spawnY + 1],
                "Removing it");
    ...
    for i = 1, majorCount do
        local player = majorAll[i];
        CSproximityMap = setPlayerProximity(CSproximityMap, mapXSize, mapYSize, CS_PLAYERS_MIN_DISTANCE, player.spawnX,
            player.spawnY, mapIsRoundWestEast);
    end
    ...
    for i = 1, 10 do
        ...
        local csPlacement = recursiveCSPlacement(minorAll, minorCount, 1, CSproximityMap, CSDistance, mapXSize,
            mapYSize, mapIsRoundWestEast)
        ...
        if (csPlacement) then
            ...
            if (mapResourceCode[player.spawnX + 1][player.spawnY + 1] ~= -1) then
                ___Debug("CS spawned on a resource:", mapResourceCode[player.spawnX + 1][player.spawnY + 1],
                    "Removing it");
                terraformBBS(player.spawnX, player.spawnY, -2, -1, -2);
            end
...
function recursiveCSPlacement(minorAll, minorCount, currentIndex, CSProximityMap, CSDistance, mapXSize, mapYSize,
    mapIsRoundWestEast)
    ...
    for i = allTilesIndex + 1, allTilesCount do
        ...
        if (not CSProximityMap[x + 1][y + 1]) then -- means that no player is in range, we can use the spawn
            if (mapScript ~= "Terra.lua" or islandLabels[x + 1][y + 1] ~= islandOneID) then
                ...
                local newMap = setPlayerProximity(CSProximityMap, mapXSize, mapYSize, CSDistance, x, y,
                    mapIsRoundWestEast);

                if (recursiveCSPlacement(minorAll, minorCount, currentIndex + 1, newMap, CSDistance, mapXSize, mapYSize,
                    mapIsRoundWestEast)) then
                    player.spawnX = x;
                    player.spawnY = y;
...
function recursivePlacement(majorAll, majorCount, currentIndex, playerProximityMap, playerDistance, mapXSize, mapYSize,
    mapIsRoundWestEast, eastTeamID, standardWaterIndex, standardCoastIndex, standardNoWaterIndex)
        ...
        for i = deepOceanIndex + 1, deepOceanCount do
            ...
            if (not playerProximityMap[x + 1][y + 1]) then -- means that no player is in range, we can use the spawn
                if rtsModeActive then
                    ...
                    isrtsCorrect = rtsCheck(x, y, midLandIndex, eastTeamID, player.teamID, player.tundraCiv,
                        player.rtsFreeSim);
                end
                ...
                if ((not rtsModeActive) or isrtsCorrect) then
                    ...
                    triedTiles = triedTiles + 1;
                    local newMap = setPlayerProximity(playerProximityMap, mapXSize, mapYSize, playerDistance, x, y,
                        mapIsRoundWestEast);

                    if (recursivePlacement(majorAll, majorCount, currentIndex + 1, newMap, playerDistance, mapXSize,
                        mapYSize, mapIsRoundWestEast, eastTeamID, standardWaterIndex, standardCoastIndex,
    ...
    for i = 1, majorCount do
        ...
        if player ~= nil then
            if (player.majorPrimaryOKSecondaryOKWaterOKCount > 0) then
                player.majorPrimaryOKSecondaryOKWaterOK =
                    GetShuffledCopyOfTable(player.majorPrimaryOKSecondaryOKWaterOK);
            end
            ...
            if (player.majorPrimaryOKSecondaryOKWaterNOKCount > 0) then
                player.majorPrimaryOKSecondaryOKWaterNOK = GetShuffledCopyOfTable(
                    player.majorPrimaryOKSecondaryOKWaterNOK);
            end

            if (player.majorPrimaryOKSecondaryNOKWaterOKCount > 0) then
                player.majorPrimaryOKSecondaryNOKWaterOK = GetShuffledCopyOfTable(
                    player.majorPrimaryOKSecondaryNOKWaterOK);
            end
            ...
            if (player.majorPrimaryOKSecondaryNOKWaterNOKCount > 0) then
                player.majorPrimaryOKSecondaryNOKWaterNOK = GetShuffledCopyOfTable(
                    player.majorPrimaryOKSecondaryNOKWaterNOK);
            end
        end
    end
                    ...
                    for k = 1, majorCount do
                        ...
                        if player.biasCount <= 0 then
                            ...
                            if (player.biasTerrain[0 + 1] ~= 0) then
                                ...
                                ringThreeTerrain = getRingTerrain(1, 3, mapTerrainCode[iIndex][jIndex], ringTerrain,
                                    terrainOne, terrainTwo);
                                ringFiveTerrain = ringThreeTerrain +
                                                      getRingTerrain(4, 5, mapTerrainCode[iIndex][jIndex], ringTerrain,
                                        terrainOne, terrainTwo);
                            ...
                            if (player.biasTerrain[1 + 1] ~= 0) then
                                ...
                                if (player.biasTerrain[0 + 1] ~= bias) then
                                    ...
                                    ringThreeTerrain = getRingTerrain(1, 3, mapTerrainCode[iIndex][jIndex], ringTerrain,
                                        terrainOne, terrainTwo);
                                    ringFiveTerrain = ringThreeTerrain +
                                                          getRingTerrain(4, 5, mapTerrainCode[iIndex][jIndex],
                                            ringTerrain, terrainOne, terrainTwo);
                            ...
                            for k = 1, 5 do
                                if (player.resourcesBiasListCount[k] > 0) then
                                    ...
                                    ringThreeResource = getRingResource(1, 3, mapResourceCode[iIndex][jIndex],
                                        ringResource, player.resourcesBiasList[k], player.resourcesBiasListCount[k]);
                                    ringFiveResource = ringThreeResource +
                                                           getRingResource(4, 5, mapResourceCode[iIndex][jIndex],
                                            ringResource, player.resourcesBiasList[k], player.resourcesBiasListCount[k]);
                            ...
                            for k = 1, 5 do
                                if (player.resourcesNegativeBiasListCount[k] > 0) then
                                    ...
                                    ringThreeResource = getRingResource(1, 3, mapResourceCode[iIndex][jIndex],
                                        ringResource, player.resourcesNegativeBiasList[k],
                                        player.resourcesNegativeBiasListCount[k]);
                                    ringFiveResource = ringThreeResource +
                                                           getRingResource(4, 5, mapResourceCode[iIndex][jIndex],
                                            ringResource, player.resourcesNegativeBiasList[k],
                                            player.resourcesNegativeBiasListCount[k]);
                            ...
                            for k = 1, 5 do
                                if (player.featuresBiasListCount[k] > 0) then
                                    ...
                                    ringThreeFeature = getRingFeature(1, 3, mapFeatureCode[iIndex][jIndex], ringFeature,
                                        player.featuresBiasList[k], player.featuresBiasListCount[k]);
                                    ringFiveFeature = ringThreeFeature +
                                                          getRingFeature(4, 5, mapFeatureCode[iIndex][jIndex],
                                            ringFeature, player.featuresBiasList[k], player.featuresBiasListCount[k]);
                            ...
                            for k = 1, 5 do
                                if (player.featuresNegativeBiasListCount[k] > 0) then
                                    ...
                                    for l = 1, player.featuresNegativeBiasListCount[k] do
                                        ___Debug("-----Negative features looked at:",
                                            player.featuresNegativeBiasList[k][l]);
                                    end

                                    ringThreeFeature = getRingFeature(1, 3, mapFeatureCode[iIndex][jIndex], ringFeature,
                                        player.featuresNegativeBiasList[k], player.featuresNegativeBiasListCount[k]);
                                    ringFiveFeature = ringThreeFeature +
                                                          getRingFeature(4, 5, mapFeatureCode[iIndex][jIndex],
                                            ringFeature, player.featuresNegativeBiasList[k],
                                            player.featuresNegativeBiasListCount[k]);
                            ...
                            if (player.biasFeature[0 + 1] <= 0 and player.biasFeature[31 + 1] <= 0 and
                                player.biasFeature[32 + 1] <= 0) then
                                ...
                                if biasMandatoryScore >= 0 then
                                    ...
                                    if biasSecondaryScore >= 0 then
                                        ...
                                        if mapFreshWater[iIndex][jIndex] then
                                            ...
                                            player.majorPrimaryOKSecondaryOKWaterOKCount =
                                                player.majorPrimaryOKSecondaryOKWaterOKCount + 1;
                                            ___Debug("Tile assigned to: Pri OK, SEC OK, Water OK");
                                        elseif mapCoastal[iIndex][jIndex] then
                                            table.insert(player.majorPrimaryOKSecondaryOKSeaOK, {i, j});
                                            player.majorPrimaryOKSecondaryOKSeaOKCount =
                                                player.majorPrimaryOKSecondaryOKSeaOKCount + 1;
                                            ___Debug("Tile assigned to: Pri OK, SEC OK, Sea OK");
                                        else
                                            table.insert(player.majorPrimaryOKSecondaryOKWaterNOK, {i, j});
                                            player.majorPrimaryOKSecondaryOKWaterNOKCount =
                                                player.majorPrimaryOKSecondaryOKWaterNOKCount + 1;
                                        ...
                                        if mapFreshWater[iIndex][jIndex] then
                                            ...
                                            player.majorPrimaryOKSecondaryNOKWaterOKCount =
                                                player.majorPrimaryOKSecondaryNOKWaterOKCount + 1;
                                            ___Debug("Tile assigned to: Pri OK, SEC NOK, Water OK");
                                        elseif mapCoastal[iIndex][jIndex] then
                                            table.insert(player.majorPrimaryOKSecondaryNOKSeaOK, {i, j});
                                            player.majorPrimaryOKSecondaryNOKSeaOKCount =
                                                player.majorPrimaryOKSecondaryNOKSeaOKCount + 1;
                                            ___Debug("Tile assigned to: Pri OK, SEC NOK, Sea OK");
                                        else
                                            table.insert(player.majorPrimaryOKSecondaryNOKWaterNOK, {i, j});
                                            player.majorPrimaryOKSecondaryNOKWaterNOKCount =
                                                player.majorPrimaryOKSecondaryNOKWaterNOKCount + 1;
...
function BBS_AssignStartingPlots:__FindBias(civilizationType)
    ...
    for row in GameInfo.StartBiasResources() do
        if (row.CivilizationType == civilizationType) then
            ...
            ___Debug("BBS_AssignStartingPlots: Add Bias : Civilization", civilizationType, "Bias Type:", bias.Type,
                "Tier :", bias.Tier, "Type :", bias.Value);
    ...
    table.sort(biases, function(a, b)
...
-- 						for dx = -3, 3, 1 do
-- 							for dy = -3, 3, 1 do
-- 								local adjacentPlot = plot:GetX(), plot:GetY(), dx, dy, 3);
...
function GetIslandPerimeter(plot, B_debug, B_first_layer, B_report)
    ...
    for w = 0, 5 do
        if (plot:GetX() >= 0 and plot:GetY() < gridHeight) then
            ...
            if test_plot ~= nil and test_plot:IsWater() and test_plot:IsLake() == false and test_plot:IsNaturalWonder() ==
                false then
                b_true_coast = true
                break
            end
            ...
            if check_plot ~= nil then
                for w = 0, 5 do
                    if (check_plot:GetX() >= 0 and check_plot:GetY() < gridHeight) then
                        ...
                        if test_plot ~= nil and test_plot:IsWater() and test_plot:IsLake() == false and
                            test_plot:IsNaturalWonder() == false then
                            b_true_coast = true
                            break
                        end
                    end
        ...
        for d = lower_bound, upper_bound, inc do
            if active_plot ~= nil and active_plot:GetX() ~= nil and active_plot:GetY() ~= nil and gridHeight ~= nil then
                if (active_plot:GetX() >= 0 and active_plot:GetY() < (gridHeight - 1) and active_plot:GetY() > 0) then
                    ...
                    if B_debug == true then
                        print("CHECK:", active_plot:GetX(), active_plot:GetY(), d, adj_plot:GetX(), adj_plot:GetY(),
                            adj_plot:IsCoastalLand())
                    end
                    local b_already_found = false
                    local b_true_ocean = false
                    -- add snow / ICE
                    if adj_plot ~= nil and adj_plot:IsWater() == false and
                        (adj_plot:GetTerrainType() ~= 15 and adj_plot:GetTerrainType() ~= 16) then
                        for w = 0, 5 do
                    ...
                    if b_already_found == false and adj_plot ~= nil and b_true_ocean == true and adj_plot:IsWater() ==
                        false and (adj_plot:GetTerrainType() ~= 15 and adj_plot:GetTerrainType() ~= 16) then
                        table.insert(perimeter_plot, adj_plot)
                        if B_debug == true then
                            print("ADD A:", adj_plot:GetX(), adj_plot:GetY(), count, "WAS AT", active_plot:GetX(),
                                active_plot:GetY())
                        end
                        count = count + 1
                ...
                elseif active_plot:GetY() == gridHeight - 1 or active_plot:GetY() == 0 then
                    ...
                    if adj_plot ~= nil and adj_plot:IsCoastalLand() == false and
                        (adj_plot:GetTerrainType() ~= 15 and adj_plot:GetTerrainType() ~= 16) then
                        local b_already_found = false
                        for p, perim_plot in ipairs(perimeter_plot) do
                            if perim_plot == adj_plot then
                        ...
                        if b_already_found == false then
                            table.insert(perimeter_plot, adj_plot)
                            if B_debug == true then
                                print("ADD B:", adj_plot:GetX(), adj_plot:GetY(), count, "WAS AT", active_plot:GetX(),
                                    active_plot:GetY())
                            end
                            count = count + 1
                            previous_plot = active_plot
                    ...
                    elseif adj_plot ~= nil and adj_plot:IsCoastalLand() == true and
                        (adj_plot:GetTerrainType() ~= 15 and adj_plot:GetTerrainType() ~= 16) then
                        local b_already_found = false
                        for p, perim_plot in ipairs(perimeter_plot) do
                            if perim_plot == adj_plot then
                        ...
                        if b_already_found == false then
                            ...
                            for n = low_p, high_p, inc_p do
                                ...
                                if adj_plot ~= nil and adj_plot:IsCoastalLand() == true and
                                    (adj_plot:GetTerrainType() ~= 15 and adj_plot:GetTerrainType() ~= 16) then
                                    ...
                                    if b_already_found == false then
                                        table.insert(perimeter_plot, adj_plot)
                                        if B_debug == true then
                                            print("ADD C:", adj_plot:GetX(), adj_plot:GetY(), count, "WAS AT",
                                                previous_plot:GetX(), previous_plot:GetY())
                                        end
                                        count = count + 1
                                        active_plot = adj_plot
                                        b_moved_away = true
                            ...
                            for n = high_p, low_p, inc_p do
                                ...
                                if adj_plot ~= nil and adj_plot:IsCoastalLand() == true and
                                    ...
                                    if b_already_found == false then
                                        table.insert(perimeter_plot, adj_plot)
                                        if B_debug == true then
                                            print("ADD D:", adj_plot:GetX(), adj_plot:GetY(), count, "WAS AT",
                                                previous_plot:GetX(), previous_plot:GetY())
                                        end
                                        count = count + 1
                                        active_plot = adj_plot
                            ...
                            for w = 0, 5 do
                                if (test_plot:GetX() >= 0 and test_plot:GetY() < gridHeight + 1) then
                                    ...
                                    if check_plot ~= nil and check_plot:IsWater() and check_plot:IsLake() == false then
                                        ...
                                        if B_debug == true then
                                            print("ADD E:", test_plot:GetX(), test_plot:GetY(), count, "WAS AT",
                                                previous_plot:GetX(), previous_plot:GetY())
                                        end
                                        count = count + 1
                                        b_ice = true
                            ...
                            for w = 0, 5 do
                                if (test_plot:GetX() >= 0 and test_plot:GetY() < gridHeight + 1) then
                                    ...
                                    if check_plot ~= nil and check_plot:IsWater() and check_plot:IsLake() == false then
                                        active_plot = test_plot
                                        if B_debug == true then
                                            print("ADD F:", test_plot:GetX(), test_plot:GetY(), count, "WAS AT",
                                                previous_plot:GetX(), previous_plot:GetY())
                                        end
                                        count = count + 1
                                        b_ice = true
                    ...
                    if island ~= island_duplicate and island ~= nil and island_duplicate ~= nil then
                        for p, plot in ipairs(island) do
                            for n, plot_duplicate in ipairs(island_duplicate) do
                                if plot ~= nil and plot_duplicate ~= nil and plot:GetX() == plot_duplicate:GetX() and
                                    plot:GetY() == plot_duplicate:GetY() then
                                    if B_debug == true then
                                        print("IS CONTINOUS", plot:GetX(), plot:GetY(), "Island A", i, "island B", j)
                                        print("IS CONTINOUS", plot_duplicate:GetX(), plot_duplicate:GetY(), "Island A",
                                            i, "island B", j)
                                    end
                        ...
                        if b_is_continuous == true then
                            for n, plot_duplicate in ipairs(island_duplicate) do
                                ...
                                if b_new_plot == true then
                                    if B_debug == true then
                                        print("ADD PLOT", "Island A", i, plot_duplicate:GetX(), plot_duplicate:GetY(),
                                            " From Island B", j)
                                    end
